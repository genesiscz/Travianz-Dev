...
class Ranking
{
    ...
    public function getUserRank($id)
    {
        ...
        $users2 = mysqli_fetch_array(mysqli_query($this->database->dblink, $users), MYSQLI_ASSOC);
        $users2 = $users2['Total'];
        $users3 = $users2 + 1;
        $myrank = 0;
        if (count($ranking) > 0) {
    ...
    public function procRankReq($get, $uid, $wref)
    {
        if (isset($get['id'])) {
            switch ($get['id']) {
                case 1:
                ...
                case 8:
                    ...
                    if ($get['hero'] == 0) {
                        ...
                        $this->getStart($this->searchRank($uid, "uid"));
                    }
                    break;
                case 11:
                    $this->procRankRaceArray(1);
                    if ($this->searchRank($uid, "userid") != 0) {
                        $this->getStart($this->searchRank($uid, "userid"));
                    } else {
                        $this->getStart(1);
                    }
                    break;
                ...
                case 2:
                    $this->procVRankArray();
                    $this->getStart($this->searchRank($wref, "wref"));
                    break;
                case 4:
                    $this->procARankArray();
                    if ($get['aid'] == 0) {
    ...
    {
        $race = $this->database->escape((int) $race);   
        $holder = [];
    ...
    public function procVRankArray()
    {
        ...
        $holder = MultiSort::sort($holder, "x", true, 2, "y", true, 2, "pop", false, 2);
        $newholder = [
            "pad"
        ];
    ...
    public function procARankArray()
    {
        ...
        $holder = MultiSort::sort($holder, "totalpop", false, 2);
        $newholder = [
            "pad"
        ];
    ...
    {        
        $array = $datagbase->getHeroRanking();
        $holder = [];
        foreach ($array as $value) {
        ...
        $holder = MultiSort::sort($holder, "experience", false, 2);
        $newholder = [
            "pad"
        ];
    ...
    public function procAAttRankArray()
    {
        ...
        $holder = MultiSort::sort($holder, "Aap", false, 2);
        $newholder = [
            "pad"
        ];
    ...
    public function procADefRankArray()
    {
        ...
        $holder = MultiSort::sort($holder, "Adp", false, 2);
        $newholder = [
            "pad"
        ];
