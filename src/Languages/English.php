...
//ERRORS
define("USRNM_TAKEN","Username is already in use.");
...
define("PASS_MISMATCH","Password mismatch");
...
define("REF_NT_FOUND","Ref does not exist.");
...
define("VAC_MODE_STILL_ENABLED","Vacation mode's still enabled");
...
//NATARS SPAWN SYSTEM
define("NATARS_SPAWN", "Natars Spawn");
define("WW_SPAWN", "WW Spawn");
define("WW_PLAN_SPAWN", "WW Plan Spawn");
