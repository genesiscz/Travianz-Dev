...
//PEACE SYSTEM
define("PEACE_NONE", "None");
define("PEACE_NORMAL", "Normal");
define("PEACE_CHRISTMAS", "Christmas");
define("PEACE_EASTER", "Easter");
define("PEACE_NEW_YEAR", "New Year");
...
define("VILLAGE_OVERVIEW","Village overview");
define("REMAINING_GOLD","Remaining gold");
define("CURRENT_GOLD","You currently have: %d gold");
define("ACCOUNT_DELETED_IN", "The account will be deleted in");

//ERRORS
define("USERNAME_TAKEN","Username is already in use.");
define("EMAIL_TAKEN","Email is already in use.");
define("TRIBE_EMPTY","Please choose a tribe.");
define("SECTOR_EMPTY","Please choose a map sector.");
define("AGREE_ERROR","You have to agree to the game rules and the general terms & conditions in order to register.");
define("USERNAME_EMPTY","Enter name.");
define("PASSWORD_EMPTY","Enter password.");
define("EMAIL_EMPTY","Enter email.");
...
define("PASSWORD_IS_TOO_WEAK","Password is too weak.");
define("ALLI_OWNER","Please appoint an alliance owner before deleting");
define("SITTER_ERROR","Sitter already set or player not found");
define("EMPTY_USER","Empty username.");
define("USER_NOT_FOUND","Name does not exist.");
define("INVALID_USERNAME","Invalid username.");
define("USERNAME_TOO_SHORT","Username is too short.");
define("USERNAME_TOO_LONG","Username is too long.");
define("PASSWORD_TOO_SHORT","Password is too short.");
define("PASSWORD_TOO_LONG","Password is too long.");
define("EMAIL_TOO_LONG","Email is too long.");
define("INVALID_REFERRAL","Invalid referral.");
define("PASSWORD_ERROR","The password is wrong.");
...
define("REGISTER_CLOSED","The registration is closed. You can't register to this server.");
...
define("VACATION_MODE_WRONG_DAYS","You've inserted a wrong number of days");
define("VACATION_MODE_STILL_ENABLED","Vacation mode's still enabled");
define("NOBODY","Nobody");

//WELCOME MESSAGE
define("WEL_MESSAGE","Hello %USER%,
...
//LOGOUT
define("LOGOUT_SUCCESSFUL", "Logout successful.");
define("LOGOUT_THANK_YOU","Thank you for your visit.");
define("LOGOUT_OTHER_PEOPLE_WARNING", "If other people use this computer too, you should delete your cookies for your own safety:");
define("LOGOUT_DELETE_COOKIES", " delete cookies");

//VILLAGE EXPANSION
define("EXP_FAST", "Fast");
...
define("CROP","Crop");
define("LEVEL","Level");
define("SHORT_LEVEL","lvl");
define("UPGRADE_IN_PROGRESS","Upgrade in progress");
...
define("BEFORE_REGISTER","Before you register an account you should read the <a href='../manual/village' target='_blank'>instructions</a> of " . Config::SERVER_NAME . " see the specific advantages and disadvantages of the three tribes.");
define("BUILDING_UPGRADING","Building:");
define("HOURS","hours");

//PASSWORD.PHP
define("NEW_PASSWORD_DESC", "Before you can request a new password you have to enter the email address that has been used to register the account.
<br /><br />Afterwards you will receive an e-mail with a new password. The password will only work after confirming it, though.");
define("FORGOTTEN_PASSWORD","Forgotten password");
define("NEW_PASSWORD", "New password");
define("PASSWORD_SENT", "If the email address exists, a new password has been sent to it.");
...
define("INCOMING_ATTACKS","Incoming attacks");
define("INCOMING_OASIS_ATTACKS","Incoming oasis attacks");
...
define("OASISREINFORCEMENT","The Oasis is being reinforced");
define("OASISREINFORCEMENTS","Oasis Reinf.");
...
define("PRISONERS_IN_THIS_VILLAGE","Prisoners in this village");
define("PRISONERS_IN_OTHER_VILLAGES","Prisoners in other villages");
define("PRISONERS_IN","Prisoners in");
define("PRISONERS_FROM","Prisoners from");
define("TROOPS","Troops");
define("OWNED_TROOPS","'s troops");
...
//VILLAGE
define("NON_EXISTENT_VILLAGE_NAME", "[?]");
define("VILLAGE","Village");
define("VILLAGE_CAPITAL","Capital");
define("OASIS","Oasis");
...
define("NAME","Name");
define("PASSWORD_FORGOTTEN","Password forgotten?");
define("PASSWORD_REQUEST","Then you can request a new one which will be sent to your email address.");
define("PASSWORD_GENERATE","Generate a new password.");
...
//FARM LIST
define("EDIT","edit");
define("ADD_RAID","Add raid");
define("EDIT_RAID","Edit raid");
define("START_RAIDS","Start raids");
define("LAST_RAID","Last raid");
define("SELECT_ALL","Select all");
define("CREATE_NEW_LIST","Create a new list");
define("LIST_NAME","List name");
define("TARGET_VILLAGE","Target village");
define("LAST_TARGETS","Last targets");
define("CREATE_FARM_LIST_FIRST","Create a farm list first");
define("INVALID_PARAMETERS","Invalid parameters");
define("INVALID_FARM_LIST","Invalid farm list");
define("INVALID_UNITS","Invalid units");
define("NO_UNITS","You must insert at least one unit");
define("VILLAGE_DOES_NOT_EXIST","The village does not exist");
define("CANNOT_SEND_UNITS_SAME_VILLAGE","You cannot send units to the same village you're sending from");
define("UNDER_BEGINNER_PROTECTION","The player is under beginner protection. You can't send units to him");
define("PLAYER_ON_VACATION_SEND_UNITS","Player is on vacation mode. You cannot send units to him");
define("BANNED_CANNOT_SEND_UNITS","Player is Banned. You cannot send units to him");
define("SELECT_VILLAGE","Select village");
...
//BUILDINGS
define("OUTER_BUILDING_SITE", "Outer building site");
define("BUILDING_SITE", "Building site");
...
define("TOO_FEW_RESOURCES","Too few resources");
define("TOO_MUCH_RESOURCES","Too much resources");
...
define("INVALID_MAX_EVASIONS", "Invalid max evasions");
define("EVASION_SETTINGS_UPDATED", "Evasion settings updated");
...
define("MERCHANT_ON_WAY","Merchants on way");
define("MERCHANT_COMING","Merchants coming");
define("MERCHANT_RETURNING","Merchants returning");
define("TRANSPORT_FROM","Transport from");
define("TRANSPORT_TO","Transport to");
define("RETURNING_FROM","Returning from");
...
define("CANNOT_USE_GOLDCLUB_FEATURES","You cannot use gold club features");
define("PLAYER_ON_VACATION","Player is on vacation mode. You cannot send resources to him");
...
define("I_AM_SEARCHING","I'm searching");
define("I_AM_OFFERING","I'm offering");
...
define("ACCEPT_OFFER","Accept offer");
...
define("INVALID_RATIO","Invalid ratio");
define("INVALID_MAXIMUM_TIME","Invalid maximum time of transport");
define("CANNOT_SELECT_SAME_RESOURCE", "You cannot select the same resource");
define("ACTUALLY_NOT_IN_ALLY", "You don't actually have an alliance");
...
define("OF","of");
define("RESOURCES_DOESNT_CORRESPOND","Resources doesn't correspond");
define("CANNOT_NPC_WW_VILLAGE", "You cannot use NPC trading in a WW village");
define("NOT_ENOUGH_GOLDS", "You don't have enough golds");
...
define("INVALID_TRADE_ROUTE", "Invalid trade route");
define("SAVE","Save");
define("NO_INSERTED_RESOURCES", "No inserted resources");
define("INVALID_VILLAGE", "Invalid village");
...
define("CHANGE_CAPITAL_DESC", "Are you sure, that you want to change your capital?<br /><b>You can't undo this!</b><br />For security you must enter your password to confirm:<br />");
...
//NATARS RELEASE SYSTEM
define("WORLD_WONDERS", "World Wonders");
define("BUILDING_PLANS", "Building Plans");
define("NATARS_TRIBE", TRIBE5." ".TRIBE);
define("WILL_BE_RELEASED_IN", "will be released in");
define("CONSTRUCTION_PLANS", "Construction Plans");
