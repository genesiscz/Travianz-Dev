<div id="content" class="login">
        ...
        <table id="login_form">
            <tbody>
                <tr class="top">
                    ...
                    <td>
                        <input class="text" type="text" name="Username" value="{if isset($Username)}{$Username}{else}{$UsernameCookie}{/if}" maxlength="30" /> <span class="error">{$UsernameError}</span></td>
                </tr>
                <tr class="btm">
                    <th>{$smarty.const.PASSWORD}</th>
                    <td>
                        <input class="text" type="password" name="Password" value="{$Password}" maxlength="100" /> <span class="error">{$PasswordError}</span>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    {/if} {/if} {if !empty($Password) and !empty($Username) and !empty($PasswordError)}
    <p class="error_box">
        <span class="error">{$smarty.const.PW_FORGOTTEN}</span>
        <br>{$smarty.const.PW_REQUEST}
        <br>
