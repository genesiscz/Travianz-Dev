<div id="content" class="signup">
    {if $isServerStarted} {if empty($code) and !empty($activate)}
    ...
    <p>
        Hello {$activate},
        <br />
        <br /> The registration was successful. In the next few minutes you will receive an email with the access information.
        <br />
        <br /> The email will be sent to following address: <span class="important">{$email}</span>
    </p>
    ...
    <div id="no_mail">
        ...
        <p>
            Sometimes the email is moved to the spam folder.
            <br />For further help click <a href="activate.php?del={$activate}">here</a>
        </p>
    </div>
    {else}
    <div id="activation">
