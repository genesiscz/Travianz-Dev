...
<td class="res"><?php
	switch($oasisarray[$i]['type']) {
		...
		case 3:
			...
			<img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="<?php echo CROP; ?>" />+25%<?php
			break;
		case 4:
		case 5:
			?><img class="r2" src="img/x.gif" alt="{$smarty.const.CLAY}" title="<?php echo CLAY; ?>" />+25%<?php
			break;
		case 6:
			?><img class="r2" src="img/x.gif" alt="{$smarty.const.CLAY}" title="<?php echo CLAY; ?>" />+25%
			<img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="<?php echo CROP; ?>" />+25%<?php
			break;
		case 7:
		case 8:
			?><img class="r3" src="img/x.gif" alt="{$smarty.const.IRON}" title="<?php echo IRON; ?>" />+25%<?php
			break;
		case 9:
			?><img class="r3" src="img/x.gif" alt="{$smarty.const.IRON}" title="<?php echo IRON; ?>" />+25%
			<img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="<?php echo CROP; ?>" />+25%<?php
			break;
		case 10:
		case 11:
			...
			break;
		case 12:
			?><img class="r4" src="img/x.gif" alt="{$smarty.const.CROP}" title="<?php echo CROP; ?>" />+50%<?php
			break;
	}
?></td>
</tr>
