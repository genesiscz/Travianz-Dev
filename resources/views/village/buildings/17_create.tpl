			...
			<table cellpadding="1" cellspacing="1" id="npc" class="transparent">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<img src="{$smarty.const.GP_LOCATE}img/r/1.gif" alt="@lang('resources.lumber')" title="@lang('resources.lumber')">
							<input class="text" type="text" name="wood" id="r1" value="" maxlength="5" tabindex="1" style="width: 50px;">
							<img src="{$smarty.const.GP_LOCATE}img/r/2.gif" alt="@lang('resources.clay')" title="@lang('resources.clay')">
							<input class="text" type="text" name="clay" id="r2" value="" maxlength="5" tabindex="1" style="width: 50px;">
							<img src="{$smarty.const.GP_LOCATE}img/r/3.gif" alt="@lang('resources.iron')" title="@lang('resources.iron')">
							<input class="text" type="text" name="iron" id="r3" value="" maxlength="5" tabindex="1" style="width: 50px;"> 
							<img src="{$smarty.const.GP_LOCATE}img/r/4.gif" alt="@lang('resources.crop')" title="@lang('resources.crop')">
