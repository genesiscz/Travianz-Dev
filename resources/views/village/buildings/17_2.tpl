        ...
        <tr>  
            ...
            <td class="res">  
                <select name="rid1" tabindex="2" class="dropdown">  
                    <option value="1" selected="selected">@lang('resources.lumber')</option>
                    <option value="2">@lang('resources.clay')</option>
                    <option value="3">@lang('resources.iron')</option>
                    <option value="4">@lang('resources.crop')</option>
                </select>  
            </td>  
            <td class="tra">
        ...
        <tr>  
            ...
            <td class="res">  
                <select name="rid2" tabindex="4" class="dropdown">  
                    <option value="1">@lang('resources.lumber')</option>
                    <option value="2" selected="selected">@lang('resources.clay')</option>
                    <option value="3">@lang('resources.iron')</option>
                    <option value="4">@lang('resources.crop')</option>
                </select>  
            </td>  
