...
<table id="send_select" class="send_res" cellpadding="1" cellspacing="1">
	<tr>
		...
		<td class="nam"> @lang('resources.lumber')</td>
		<td class="val">
    ...
    <tr> 
		...
		<td class="nam"> @lang('resources.clay')</td>
		<td class="val">
    ...
    <tr> 
		...
		<td class="nam"> @lang('resources.iron')</td>
		<td class="val">
    ...
    <tr> 
		...
		<td class="nam"> @lang('resources.crop')</td>
		<td class="val"> 
...
<table id="send_select" class="send_res" cellpadding="1" cellspacing="1"><tr> 
		<td class="ico"> 
			<a href="#" onClick="upd_res('wood', 1, 1); return false;"><img class="r1" src="assets/img/x.gif" alt="@lang('resources.lumber')" title="@lang('resources.lumber')" /></a>
		</td> 
		<td class="nam"> 
			@lang('resources.lumber'):
		</td> 
		<td class="val"> 
		...
		<td class="ico"> 
			<a href="#" onClick="upd_res('clay', 2, 1); return false;"><img class="r2" src="assets/img/x.gif" alt="@lang('resources.clay')" title="@lang('resources.clay')" /></a>
		</td> 
		<td class="nam"> 
			@lang('resources.clay'):
		</td> 
		...
		<td class="ico"> 
			<a href="#" onClick="upd_res('iron', 3, 1); return false;"><img class="r3" src="assets/img/x.gif" alt="@lang('resources.iron')" title="@lang('resources.iron')" /></a>
		</td> 
		<td class="nam"> 
			@lang('resources.iron'):
		</td> 
		...
		<td class="ico"> 
			<a href="#" onClick="upd_res('crop', 4, 1); return false;"><img class="r4" src="assets/img/x.gif" alt="@lang('resources.crop')" title="@lang('resources.crop')" /></a>
		</td> 
		<td class="nam"> 
			@lang('resources.crop'):
		</td> 
...
{foreach $villageMarketplaceTrades['from'] as $trade}
	{include file={$smarty.const.TEMPLATES_DIR}|cat:'village/buildings/trade.php.blade'}
{/foreach}
