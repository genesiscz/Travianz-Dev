<table id="production" cellpadding="1" cellspacing="1">
    <thead>
    <tr>
        <th colspan="4">@lang('village/production.production'):</th>
    </tr>
    </thead>
    <tbody>
    <tr>
        ...
        <td class="num">{{ $village->total_production->get(App\Game\Resources\Lumber::class) }}</td>
    ...
    <tr>
        ...
        <td class="num">{{ $village->total_production->get(App\Game\Resources\Clay::class) }}</td>
        <td class="per">@lang('village/production.per_hour')</td>
    </tr>
    ...
    <tr>
        ...
        <td class="num">{{ $village->total_production->get(App\Game\Resources\Iron::class)  }}</td>
        <td class="per">@lang('village/production.per_hour')</td>
    </tr>
    ...
    <tr>
        ...
        <td class="num">{{ $village->total_production->get(App\Game\Resources\Crop::class) - $village->getTotalUpkeep() }}</td>
        <td class="per">@lang('village/production.per_hour')</td>
    </tr>
    </tbody>
</table>
