...
namespace App\Game\Units\Teutons;
...
final class Axeman extends Unit
{
    /**
     * {@inheritDoc}
     * @see Unit::ATTACK
     ...
     */
    public const TRAIN_NEEDED_TIME = 1500;
     ...
     */
    protected const TRAIN_NEEDED_RESOURCES = [130, 120, 170, 70];
}
